...
\label{sec: dif_quot}
Wird \eqref{eq:ausgleichsfunktion_3} nach der Zeit differenziert, ergibt sich mittels Quotientenregel
\begin{align*}
...
\begin{table}
    ...
    \centering
\end{table}
%Abweichung nu:  [0.06100218 0.16197183 0.1827957  0.17567568]
