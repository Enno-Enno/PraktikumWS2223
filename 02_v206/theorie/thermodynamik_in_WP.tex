...
\begin{align}
    \Delta Q_\text{w}    &= A + \Delta Q_\text{k} % DIe Q_i hängen selber auch mit veränderungen in der Temperatur zusammen...
\end{align}
%
Die Wärmepumpe muss also die Arbeit $\Delta W = A$ aufwenden um die Wärmeenergie aus Reservoir k in Reservoir w zu überführen.
