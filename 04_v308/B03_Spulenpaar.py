...
ax6.plot(x_6[:4], magnetfeld_6[:4], 'x', label="Magnetfeldstärke")
ax6.plot(x_6[:4], mw_6, label="$\\overline{{B}}$")
ax6.grid()
...
ax12.grid()
ax12.plot(x_12[7:], magnetfeld_12[7:], 'x', label="Magnetfeldstärke")
ax12.plot(x_12[7:], mw_12, label="$\\overline{{B}}$")
...
ax24.plot(x_24[:13], magnetfeld_24[:13], 'x', label="Magnetfeldstärke")
ax24.plot(x_24[:13], mw_24, label="$\\overline{{B}}$")
ax24.grid()
