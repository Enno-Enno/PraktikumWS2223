...
%
    ...
    %
\end{align*}
Analog folgt für unten eine Fallzeit von der Mittelwert $\overline{t}_{\text{unten}} = \qty[]{12.248}{\s}$
und die Standardabweichung $\Delta\overline{t}_{\text{unten}} = \qty[]{0.184}{\s}$.
...
Mit Gleichung \eqref{eq:empirisch} folgt somit für die Viskosität $\eta \simeq \left(1.152 \pm 0.018\right) 10^{-3} \, \unit{\pascal \s}$.
