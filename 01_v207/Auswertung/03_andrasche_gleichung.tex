...
\begin{table}[]
    ...
    \begin{tabular}{S[table-format=2.0] S[table-format=2.2] S  S  S }
        \toprule
        & \multicolumn{2}{c}{Fallzeit $ t / \unit{\s}$} & \multicolumn{2}{c}{ $ \overline{t} / \unit{\s}$} \\
...
%Idee für die Diskussion hier vielleicht noch Vergleichswerte aus dem Geschke hinzufügen.
\begin{table}
    \centering
