...
Verglichen mit den Abbildungen im Anhang sieht es allerdings so aus, als wäre versehentlich bei der Durchführung ohne den Noise Generator eine Phase von 
...
\noindent
Es ist leicht erkennbar, dass die beiden Ausgleichsfunktionen nah beieinander liegen. 
...
%%%%%% Fragen!!!
%%%%%%
% Woher kommt \Delta U_0?
% Wann wird die Differenz zwischen eingestelltem Wert und gemessenen wert gebildet?
was einer relativen Abweichung von $U_0 = \qty{10}{\milli\volt}$ um $\Delta U_{0,\text{noise}} = - \left(\num[]{56.9} \pm \num[]{0.9}\right) \, \%$ entspricht.
