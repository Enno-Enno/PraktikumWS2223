...
\begin{align}
    p_\text{sät}(T) = \num{5.5} \cdot 10^7 \cdot \exp(-\frac{6876}{T})
\end{align}
...
Liegt $p_\text{sät}$ unterhalb, ist es zunehmend wahrscheinlich, dass keine Stöße stattfinden.
...
Das hängt damit zusammen, dass das Elektron, welches mit dem Atom stößt, eines von zweien Schalenelektronen mit entgegen gesetzter Spinrichtung ersetzt.